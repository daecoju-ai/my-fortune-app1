...
# ★★★ 여기부터 홍보 추가 ★★★
st.markdown("---")
st.markdown("### 💧 생활을 더 편리하게! **다나눔렌탈**에서 지금 문의하세요! 💧")
st.markdown("""
**정수기, 안마의자, 공기청정기, 생활 주방 가전, 서빙로봇, 인터넷 가입 문의**  

**정수기 렌탈료 제휴카드 적용 시 월 0원~**  
**설치 당일 최대 50만원 페이백** 이벤트 진행 중! 🎉  

👉 자세한 상담 및 신청은 [www.다나눔렌탈.com](http://www.다나눔렌탈.com) 으로!  
(※ 실제 사이트 확인 후 이용해주세요~)
""")
