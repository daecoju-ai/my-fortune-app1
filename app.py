...
def render_result(dbs):
    ...
    # ✅ CTA 버튼 2종 (타로 아래) - 링크만 분리 적용
    st.markdown(
        """
        <div class="card" style="text-align:center; margin-top:14px;">
          <div style="font-weight:900; font-size:1.05rem; margin-bottom:10px;">
            ☕ 미니게임 하고 커피쿠폰 받기
          </div>
          <a class="ad-btn" href="https://incredible-dusk-20d2b5.netlify.app/" target="_blank" style="display:block; margin-bottom:10px;">
            미니게임하고 커피쿠폰 받기
          </a>

          <div style="font-weight:800; font-size:0.95rem; margin:10px 0 6px;">
            📞 정수기 무료 상담
          </div>
          <a class="ad-btn" href="https://fascinating-parfait-92a985.netlify.app/" target="_blank" style="display:block;">
            무료 상담하기
          </a>

          <div class="ad-sub" style="margin-top:10px; font-size:0.8rem;">
