...
if not st.session_state.result_shown:
    ...
    st.session_state.year = col1.number_input("년", 1900, 2030, st.session_state.year, step=1)
    st.session_state.month = col2.number_input("월", 1, 12, st.session_state.month, step=1)
    st.session_state.day = col3.number_input("일", 1, 31, st.session_state.day, step=1)
